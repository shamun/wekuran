...
(function () {
  ...
  var defaultConfiguration = {
    ...
    // won't come up
    suppressJoinConfirmation: true, //default false
  ...
  var baseUrl = "https://cob.attendedbyhumans.com";
  ...
  var defaultHubBase = "https://hub.attendedbyhumans.com";
  ...
  var m = /&?teleportel=([^&]*)/.exec(hash);
  if (m) {
    uuid.joined = true;
    console.log('############### JOINED', uuid.joined);
